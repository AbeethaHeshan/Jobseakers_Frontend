...
export default function TransparentScreen(props) {
  return (
    <div style={{position:'absolute',width:'150vh',height:'85vh',backgroundColor:'#FFFFFF',top:'0',bottom:'0',left:"0",right:'0',margin:'auto',border:'2px solid #DFD7FF',borderRadius:'10px',display:props.visible ? 'flex' : 'none'}}>
